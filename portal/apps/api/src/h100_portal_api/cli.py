...
def main() -> int:
    ...
    bootstrap.add_argument("--base-url", default="http://10.10.10.220:18080")
    ...
    portal4a_user.add_argument("--base-url", default="http://10.10.10.220:18080")
    ...
    portal4a_credential.add_argument("--base-url", default="http://10.10.10.220:18080")
