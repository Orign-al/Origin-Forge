...
```bash
sudo bash -c \
  'set -a; . /etc/h100-portal/portal.env; set +a; exec /usr/bin/setpriv --reuid=h100-portal-api --regid=h100-portal-api --init-groups /opt/h100-portal/venv/bin/h100-portal-admin bootstrap-origin-al --reset-setup-token --base-url http://20.10.10.3:18080'
```
...
批准的 EasyTier 客户端可直接打开 CLI 显示的 `20.10.10.3:18080` 一次性 URL。如需
